...
Т.е. команда та же самая, что и на первом сервере, но в конце мы указываем токен с него.
